...
#define RRA_30M \
	"RRA:AVERAGE:0:" STEPS30M ":" ROWS,

#define RRA_6H \
	"RRA:MIN:0:" STEPS6H ":" ROWS, \
	"RRA:MAX:0:" STEPS6H ":" ROWS, \
	"RRA:AVERAGE:0:" STEPS6H ":" ROWS,

#define RRA_1D \
	"RRA:MIN:0:" STEPS1D ":" ROWS, \
	"RRA:MAX:0:" STEPS1D ":" ROWS, \
	"RRA:AVERAGE:0:" STEPS1D ":" ROWS,

#define RRA_30D \
	"RRA:MIN:0:" STEPS30D ":" ROWS, \
	"RRA:MAX:0:" STEPS30D ":" ROWS, \
	"RRA:AVERAGE:0:" STEPS30D ":" ROWS,

#define RRA_1Y \
	"RRA:MIN:0:" STEPS1Y ":" ROWS, \
	"RRA:MAX:0:" STEPS1Y ":" ROWS, \
	"RRA:AVERAGE:0:" STEPS1Y ":" ROWS,
